...
$db = mysql_connect('localhost', 'steamcas_easy', 'BD124218BD124218') or die(mysql_error());
mysql_select_db('steamcas_easy',$db) or die('Could not select database:'.mysql_error());
